...
class Task {
  const Task({required this.title, this.icon, this.theme, required this.left, required this.done});
  final String title;
  final IconData? icon;
  final Color? theme;
  final String left;
...
const List<Task> task = <Task>[
  ...
  const Task(title: 'Health', icon: Icons.health_and_safety, theme: kBlue, left: '1 left', done: '1 done'),
